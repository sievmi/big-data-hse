...
/**
  * Created by sievmi on 14.11.18
  */
object PopularBrowserCache {
  def main(args: Array[String]) {

    val conf: SparkConf = new SparkConf().setAppName("Popular browsers with cache").setMaster("yarn")
    ...
    topBrowsersRDD.saveAsTextFile("/user/esidorov/hw5/rdd/task5")
  }
